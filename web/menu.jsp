    ...
    <body>
        ...
        <div data-role="page" id="pageone">
            <div data-role="panel" id="myPanel" data-display="push" data-theme="b"> 
                ...
                <div class="nav-glyphish-example">
                 <ul data-role="listview">
                    ...
                    <li data-icon="user" class="ui-shadow-icon ui-btn ui-shadow ui-corner-all ui-btn-b"><a href="./Tutores/tutores.html" onclick="fadeOut(500)" target="Marco">Registro</a></li> 
            ...
            <div data-role="main" class="ui-content">
                ...
                <form data-role="popup" id="popupPrincipal" data-overlay-theme="b" data-theme="b" data-dismissible="false" style="max-width:400px;" class="ui-corner-all" style="padding: 1px; width: 300px"  method="post">

...
<html>
    ...
    <body>
        <div align="center">
            <form method="get" action="../jsp/RegistroUsuario.jsp" id="FormRegistro" style="align-items: center; width:500px; height: 200px;">
                    ...
                          <div class="ui-body ui-body-a ui-corner-all">
                        ...
                        <input autocomplete="off" type="text" pattern="[A-Za-z0-9]{1,20}" title="Sin caracteres especiales y menos de 20" data-clear-btn="true" name="Password" id="Password" placeholder="Contraseña" required> 
